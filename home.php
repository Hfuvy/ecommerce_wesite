...
<body>
    ...
    <h1 class="heading">shob by category</h1>
    ...
    <section class="home-category">
        <div class="swiper category-slider">
            <div class="swiper-wrapper">
                ...
                <a href="category.php?category=fredge" class="swiper-slide slide">
  ...
  <script>
    var swiper1 = new Swiper(".home-slider", {
      ...
      autoplay: {
        ...
        disableOnInteraction: false, // Permet à l'autoplay de continuer même après une interaction
      },
      pagination: {
